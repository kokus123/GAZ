...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
    <div>
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-1">
            ...
            <span class="text-gray-800 font-medium">Nouvelle livraison</span>
        </div>
        <h1 class="text-2xl font-bold text-gray-800">Nouvelle Livraison</h1>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-green-100 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-green-50 to-white">
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-800">Informations de la livraison</p>
                    <p class="text-xs text-gray-500">Remplissez les champs obligatoires (*)</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 space-y-6">
            ...
            {{-- Ligne 1 : Commande + Statut --}}
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">

                {{-- Commande --}}
                <div class="space-y-1.5">
                    <label for="commande_id" class="block text-sm font-semibold text-gray-700">
                        Commande <span class="text-green-600">*</span>
                    </label>
                    <div class="relative">
            ...
            <div class="space-y-1.5">
                ...
                <p class="text-xs text-gray-400">Optionnel — laissez vide si la date n'est pas encore connue</p>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="notes" id="notes" rows="4"
                          placeholder="Informations complémentaires sur la livraison, instructions spéciales..."
                          class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all text-gray-700 resize-none placeholder-gray-400">{{ old('notes') }}</textarea>
            </div>
