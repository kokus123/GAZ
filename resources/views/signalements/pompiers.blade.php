...
@section('title', 'Signaler aux Pompiers — GazApp')
...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Signaler aux Pompiers</h1>
            <p class="text-sm text-gray-500 mt-0.5">Signalez un incendie, accident ou danger public</p>
        </div>
    </div>

    {{-- Bannière urgence --}}
    <div class="mb-6 p-5 rounded-2xl border" style="background:#fff7ed;border-color:#fed7aa;">
        <div class="flex gap-3 items-start">
            ...
            <div>
                <p class="text-sm font-bold text-orange-800 mb-1">En cas d'urgence immédiate, appelez directement :</p>
                <p class="text-2xl font-black text-orange-700">🚒 18 — Pompiers</p>
                <p class="text-sm text-orange-600 mt-1">ou le <strong>112</strong> (Urgences). Ce formulaire est pour les signalements non urgents.</p>
            </div>
        </div>
    </div>
    ...
    {{-- Formulaire --}}
    <div class="bg-white rounded-3xl shadow-sm border border-orange-50 overflow-hidden">

        <div class="h-1.5 w-full" style="background:linear-gradient(90deg,#ea580c,#f97316,#fbbf24)"></div>

        <div class="p-8">
            <form action="{{ route('signalements.pompiers') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="5" required
                                  placeholder="Décrivez en détail l'incident, l'ampleur, les risques, etc..."
                                  class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-800 text-sm
                                         focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition resize-none">{{ old('description') }}</textarea>
                    </div>
                        ...
                        <div class="relative">
                            <select name="type_incident" id="type_incident" required
                                    class="w-full pl-4 pr-10 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-800 text-sm font-medium
                                           focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent appearance-none transition">
                                ...
                                <option value="fuite_gaz"     {{ old('type_incident') == 'fuite_gaz'     ? 'selected' : '' }}>⚠️ Fuite de gaz</option>
                    ...
                    <div>
                        <label for="personnes_impliquées" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                            Personnes impliquées
                        </label>
                    ...
                    {{-- Matériel impliqué --}}
                    <div>
                        <label for="matériel_impliqué" class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                            Matériel impliqué
                        </label>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="témoins" id="témoins" rows="3"
                                  ...
                                  class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-gray-800 text-sm
                                         focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition resize-none">{{ old('témoins') }}</textarea>
                    </div>
                ...
                <div class="mt-6 p-4 rounded-2xl border" style="background:#f0fdf4;border-color:#bbf7d0;">
                    <div class="flex gap-2 items-start">
                        ...
                        <div class="text-xs text-green-800 space-y-0.5">
                            ...
                            <p>• En cas d'urgence, appelez directement le <strong>18</strong></p>
                        </div>
                    </div>
                </div>
